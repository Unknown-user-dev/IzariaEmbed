...
const default_author = "IzariaEmbed";
const default_author_img = "https://i.imgur.com/Zz1TWsP.png";
const default_author_link = "https://github.com/Unknown-user-dev";
const default_title = "TITRE DE L'EMBED";
const default_title_link = "https://github.com/Unknown-user-dev";
...
const default_background = "https://cdn.discordapp.com/attachments/793909293090209812/841439887843524608/images.png";
const default_thumbnail = "";
const default_footer = "IzariaEmbed par Unknown User";
...
function video() {
  shell.openExternal("https://www.youtube.com/channel/UC5yf3kVUKzyfk_tqtBqE8nA");
}
...
bot.on("ready", () => {
  ...
  update_client();
  update_guilds();
  bot.user.setActivity("IzariaEmbed", {
    type: "WATCHING"
  });
});
